...
> Snapshot 1
    ...
    export interface UserPromise extends Promise<User>, Fragmentable, Node {␊
      ...
      profilePicture: <T = PicturePromise>(␊
    ...
    export interface ReviewPromise extends Promise<Review>, Fragmentable, Node {␊
      ...
      experience: <T = ExperiencePromise>(␊
    ...
    export interface CreditCardInformationPromise␊
      ...
      paymentAccount: <T = PaymentAccountPromise>(␊
    ...
    export interface PaymentAccountPromise␊
      ...
      paypal: <T = PaypalInformationPromise>(␊
        args?: { where?: PaypalInformationWhereInput }␊
      ) => T;␊
      creditcard: <T = CreditCardInformationPromise>(␊
    ...
    export interface PaymentPromise extends Promise<Payment>, Fragmentable, Node {␊
      ...
      paymentMethod: <T = PaymentAccountPromise>(␊
        args?: { where?: PaymentAccountWhereInput }␊
      ) => T;␊
    }␊
    ␊
    ...
    export interface LocationPromise extends Promise<Location>, Fragmentable, Node {␊
      ...
      lat: () => Promise<Float>;␊
      lng: () => Promise<Float>;␊
      neighbourHood: <T = NeighbourhoodPromise>(␊
      ...
      restaurant: <T = RestaurantPromise>(␊
    ...
    export interface ExperiencePromise␊
      extends Promise<Experience>,␊
        ...
        Node {␊
      id: () => Promise<ID_Output>;␊
      category: <T = ExperienceCategoryPromise>(␊
